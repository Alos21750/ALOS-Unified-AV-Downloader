#!/usr/bin/env python
# coding: utf-8
"""Grouped, stable-ID category registry for UAV Watcher."""
...
from uav_downloader.sites.hanime1 import Hanime1Browser
...
# for saved UAV Watcher selections while using the live route spelling.
