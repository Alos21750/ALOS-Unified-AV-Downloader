#!/usr/bin/env python
# coding: utf-8
"""Grouped, stable-ID category registry for ALOS Watch."""

from urllib.parse import quote

from alos_downloader.i18n import sites as site_i18n
from alos_downloader.i18n.locales import T
...
from alos_downloader.sites.hanime1 import Hanime1Browser
...
# for saved ALOS Watch selections while using the live route spelling.
