#!/usr/bin/env python
# coding: utf-8
"""ALOS Browse: interactive JableTV, MissAV, SupJav, and Hanime1 GUI."""
...
from alos_downloader.core.ssl import SharedSSLAdapter, get_shared_ssl_context
from alos_downloader.sites.jabletv import JableTVBrowser
from alos_downloader.sites.missav import MissAVBrowser
from alos_downloader.sites.supjav import SupJavBrowser
from alos_downloader.sites.hanime1 import Hanime1Browser, SiteHanime1
from alos_downloader.sites.base import MirrorsBlockedError
from alos_downloader.core.config import headers
from alos_downloader.i18n.locales import T, set_lang, get_lang, ui_font, LANGUAGES, state_label
from alos_downloader.subtitles.engine import (
    SubtitleCancelled,
    generate_subtitles,
    normalize_recognition_quality,
    normalize_subtitle_mode,
)
from alos_downloader.ui.translation_settings import (
...
from alos_downloader.ui.theme import (
...
from alos_downloader.metadata import APP_DISPLAY_NAMES, PRODUCT_NAME, VERSION

APP_VERSION = VERSION

# issue #24: startup breadcrumbs — no-op if crashlog unavailable
try:
    from alos_downloader.core.crashlog import breadcrumb as _crumb
except Exception:
    def _crumb(msg):
        pass
...
class ModernApp(ctk.CTk):
    def __init__(self, url: str = '', dest: str = 'download', lang: str = 'en'):
        ...
        from alos_downloader.sites.base import set_resolution_pref
    ...
    def _resolution_label(self):
        from alos_downloader.sites.base import get_resolution_pref
    ...
    def _apply_language(self, code):
        ...
        from alos_downloader.sites.base import get_resolution_pref, set_resolution_pref
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(brand, text='INTERACTIVE DOWNLOADER  /  ALOS',
    ...
    def _build_settings_tab(self):
        ...
        ctk.CTkLabel(
            about_body,
            text='ALOS Browse  ·  JableTV / MissAV / SupJav / Hanime1',
                     text_color=ACCENT,
    ...
    def _on_speed_change(self, val):
        from alos_downloader.sites.base import speed_limiter
        val = str(val)
