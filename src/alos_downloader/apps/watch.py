#!/usr/bin/env python
# coding: utf-8
"""ALOS Watch — unattended downloader with site/category/date selection.
    ...
    if local_output:
        try:
            ...
            try:
                ...
                pass
            from alos_downloader.subtitles.engine import run_local_translation_diagnostic
    ...
    if llm_output:
        try:
            ...
            try:
                ...
                pass
            from alos_downloader.subtitles.engine import run_llm_translation_diagnostic
...
from alos_downloader.sites.base import fetch_with_mirrors, MirrorsBlockedError
from alos_downloader.core import config
from alos_downloader.i18n.locales import T, set_lang, get_lang, ui_font, LANGUAGES
from alos_downloader.apps.watch_categories import (
    SITES,
    find_target,
    group_label,
    iter_targets,
...
# Keep the optional AI subtitle stack off ALOS Watch's startup path.  Frozen
...
def generate_subtitles(*args, **kwargs):
    from alos_downloader.subtitles.engine import generate_subtitles as _generate_subtitles
...
from alos_downloader.core import paths as product_paths
from alos_downloader.metadata import APP_DISPLAY_NAMES, VERSION
    ...
    def _download_one(self, video: dict, dest: str, subtitle_mode: Optional[str] = None):
        ...
        try:
            ...
            if subtitle_mode != 'none':
                ...
                try:
                    from alos_downloader.subtitles.engine import SubtitleCancelled
