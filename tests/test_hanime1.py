...
import M3U8Sites
import M3U8Sites.SiteHanime1 as hanime_mod
...
from video_identity import site_from_url, trusted_chinese_subtitle_evidence
...
def test_hanime1_is_exposed_by_every_desktop_browser_and_listing_detection():
    ...
    from gui_modern import ModernApp, SITES as MODERN_SITES
    from smalltool_categories import SITES as SMALLTOOL_SITES
