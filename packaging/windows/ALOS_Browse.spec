...
hiddenimports = [
    ...
    'alos_downloader.core.crashlog', 'certifi', 'faulthandler',
    'alos_downloader.core.updater', 'alos_downloader.core.ssl',
...
a = Analysis(
    ['..\\..\\src\\alos_downloader\\entrypoints\\browse.py'],
    pathex=['..\\..\\src'],
    binaries=binaries,
    datas=datas,
