...
hiddenimports = [
    ...
    'uav_downloader.core.crashlog', 'certifi', 'faulthandler',
    'uav_downloader.core.updater', 'uav_downloader.core.ssl',
...
a = Analysis(
    ['..\\..\\src\\uav_downloader\\entrypoints\\browse.py'],
    pathex=['..\\..\\src'],
    binaries=binaries,
    datas=datas,
